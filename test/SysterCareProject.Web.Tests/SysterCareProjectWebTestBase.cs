...
{
    public abstract class SysterCareProjectWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static SysterCareProjectWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(SysterCareProjectWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<SysterCareProjectDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<SysterCareProjectDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<SysterCareProjectDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<SysterCareProjectDbContext, Task<T>> func)
        {
            T result;
